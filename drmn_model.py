...
class drmn_Industry(drmn_Basic):
    def __init__(self,
                 path,
                 trainset,
                 testset,
        ...
        super(drmn_Industry, self).__init__(
...
if __name__ == '__main__':
    ...
    if dataset_name == 'placeholder':
        ...
        fin = open('../data/placeholder/dataset_drmn.pkl', 'rb')
        trainset = pkl.load(fin)
        testset = pkl.load(fin)
        feature_size = pkl.load(fin)
        fin.close()
        ...
        print ("Dataset must be one of placeholder or placeholder.")
        exit (1)
